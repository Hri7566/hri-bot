...
client.on('a', msg => {
  ...
  if (toggle == 1) {
    if (!isBlocked) {
      switch (cmd) {
        case '^help':
          chat("Commands: ^help | ^about | ^name | ^id | ^goto | ^cursor | ^magic8ball | ^magicconchshell | ^quote | ^crown | ^kill | ^slap | ^eat | ^rps | ^background | ^quotemaker | ^rur | ^whereisbopit");
          break;
        case '^about':
        ...
        case "^goto":
          ...
          break;
        case "^whereisbopit":
          chat("Bopit is around somewhere. His _ID is f236343b2bea9e6d181092f9 if you want to look for him.");
          break;
        case "^cursors":
        case "^cursor":
          if (argcat == "") {
...
TasteArray = [
  ...
  "was so amazing, Gordon Ramsay would be proud",
  "tasted like chicken",
  "had gone bad",
  "was to hot to enjoy",
  "was poisoned",
...
var fish = ["Angelfish",
 ...
 "Yellow Perch",
 "Zebra Turkeyfish"];
var fish_without_images =  ["Blowfish",
 "Brook Trout",
 "Butterflyfish",
 "Can",
 "Giant Trevally",
...
http.createServer(function (request, response) {
  ...
  response.end("welcome to hri's bot page :)\nthis is just here so heroku doesn't freak out");
